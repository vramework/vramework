...
describe('runRoute', () => {
  ...
  it('should throw NotFoundError when no matching route is found', async () => {
    ...
    await expect(runRoute(request, response, services, createSessionServices, routes, { route: apiRoute, type: apiType }))
  ...
  it('should call the route function and return its result when a matching route is found', async () => {
    ...
    const result = await runRoute(request, response, services, createSessionServices, routes, { route: apiRoute, type: apiType });
  ...
  it('should verify permissions if provided', async () => {
    ...
    await runRoute(request, response, services, createSessionServices, routes, { route: apiRoute, type: apiType });
...
describe('getUserSession', () => {
  ...
  it('should throw NotImplementedError when session is required but sessionService is not provided', async () => {
    await expect(getUserSession(undefined, true, request))
      .to.be.rejectedWith(NotImplementedError, 'Session service not implemented');
  });
