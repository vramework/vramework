 ...
 */
export type CoreScheduledTask<APIFunction extends CoreAPIFunctionSessionless<void, void>, UserSession extends CoreUserSession = CoreUserSession> = {
    name: string
    schedule: string
    func: APIFunction,
    docs?: APIDocs,
 ...
 */
export type CoreScheduledTasks = Array<CoreScheduledTask<CoreAPIFunctionSessionless<void, void>>>
