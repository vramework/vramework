...
export const loadAPIFilePaths = async (dir: string, filesWithRoutes: string[]): Promise<string[]> => {
...
export const loadAPIFiles = async (relativeDirectory: string, routesDirPaths: string[]) => {
