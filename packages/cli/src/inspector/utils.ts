...
export const getTypeOfFunctionArg = (checker: ts.TypeChecker, funcProperty: ts.ObjectLiteralElementLike | undefined, argIndex: number) => {
...
export const getFunctionTypes = (checker: ts.TypeChecker, funcProperty: ts.ObjectLiteralElementLike) => {
    ...
    return { inputType: nullifyTypes(inputType), outputType: nullifyTypes(outputType), paramType }
}
