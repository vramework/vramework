...
export const addFileWithFactory = (
    ...
    if (ts.isVariableDeclaration(node)) {
        ...
        if (variableTypeNode && ts.isTypeReferenceNode(variableTypeNode)) {
            ...
            if (ts.isIdentifier(typeNameNode) && typeNameNode.text === expectedTypeName) {
                ...
                variables.push({ variable: variableName, type: typeNameNode.getText(), typePath: typeDeclarationPath })
