...
export const getFileImportRelativePath = (
  ...
  return filePath.replace('.ts', esm ? '.js' : '')
}
  ...
  if (errors.size > 0) {
    ...
    errors.forEach((filesAndMethods, message) => {
      ...
      filesAndMethods.forEach((methods, file) => {
        result.push(
          `\t* file: ${getFileImportRelativePath(outputFile, file, packageMappings, esm)}`
        )
        result.push(
...
* This file was generated by @vramework/cli@${pkg.version}
*/\n\n`
